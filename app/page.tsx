              ...
              <table className="w-full border-collapse table-fixed min-w-[380px]">
                <thead>
                  <tr className="bg-slate-50 border-b">
                    <th className="w-[12%] py-2 text-[10px] font-bold text-slate-400">春</th>
              ...
              <table className="w-full border-collapse text-center">
                <thead>
                  <tr className="bg-yellow-200 border-b">
                    <th className="py-2 border-r text-xs font-bold">科目名</th>
                    <th className="py-2 border-r text-xs font-bold w-16">出席</th>
                    <th className="py-2 border-r text-xs font-bold w-16">迟到</th>
                    <th className="py-2 text-xs font-bold w-16">欠席</th>
                  </tr>
                </thead>
                <tbody>
                  {courses.map(course => {
